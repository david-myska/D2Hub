...
{
    ClassDB::bind_method(D_METHOD("log", "p_message", "msg_type"), &LogView::_log, DEFVAL(static_cast<int>(MessageType::Info)));

    ClassDB::bind_integer_constant("Logger", "MsgType", "INFO", static_cast<int>(MessageType::Info));
    ClassDB::bind_integer_constant("Logger", "MsgType", "WARNING", static_cast<int>(MessageType::Warning));
    ClassDB::bind_integer_constant("Logger", "MsgType", "ERROR", static_cast<int>(MessageType::Error));
